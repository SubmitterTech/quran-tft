            ...
            <div>
                ...
                <div className={`w-full flex z-[220] ${colors[theme]["surface"]["base"]} fixed bottom-0`}
                    ...
                    <div className={`relative flex w-full items-center justify-between`}>
                        ...
                        <div className={`w-1/2 h-full`}>
                            {multiSelect ?
                                (<button onClick={handleShare}
                                    ...
                                    className={`${colors[theme]["text"]["on-deep-soft"]} flex items-center w-full h-full justify-end`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-7 h-7 lg:w-10 lg:h-10 ${selectedVerseList.length > 0 ? `${colors[theme]["text"]["on-deep"]}` : ``}`}>
                                ...
                                (
                                    <LongPressable
                                        ...
                                        <button
                                            ...
                                            className={`w-full h-full ${colors[theme]["text"]["on-deep"]} px-2 ${direction === 'rtl' ? 'ml-1' : 'mr-2'} flex items-center justify-center ${direction === 'rtl' ? (isJumpOpen || (selectedApp === 38 && currentPage === 397) || isMagnifyOpen) ? "opacity-0" : "opacity-100" : (isJumpOpen || currentPage === 1 || isMagnifyOpen) ? "opacity-0" : "opacity-100"}`}>
                                            ...
                                            {direction !== 'rtl' && pageHistory.length > 0 && rememberHistory && (
                                                <div className={`bg-transparent absolute translate-y-3 -translate-x-3 text-xs lg:translate-y-4 lg:-translate-x-4 lg:text-base ${colors[theme]["accent"]["on-deep"]} flex items-center justify-center px-2 py-1 rounded-full`}>
                                                    {pageHistory.length}
                                                </div>
                                            )}
                                        </button>
                        ...
                        <div
                            dir={direction}
                            className={`w-full flex items-center ${colors[theme]["text"]["on-deep-soft"]} justify-center p-0.5`}>
                            <div className={`menu-icon flex items-center justify-center self-center`}>
                                {
                                    isJumpOpen ?

                                        (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-11 h-11 lg:w-14 lg:h-14 ${colors[theme]["text"]["on-deep"]}`} onClick={() => handleToggleJump()}>
                            ...
                            {!isMagnifyOpen &&
                                (parseInt(currentPage) < 23 ? (
                                    <div className={` relative h-11 lg:h-14 ${isJumpOpen ? `w-0` : `${direction === 'rtl' ? 'mr-2.5' : 'ml-2.5'} w-12 lg:w-16 `} transition-all duration-200 ease-out `}>
                                        <div
                                            className={` absolute -top-1 h-full w-full text-3xl lg:text-4xl ${colors[theme]["text"]["on-deep"]} flex items-center justify-start ${isJumpOpen ? `hidden` : `w-20`}`}
                                    ...
                                    <div className={` relative h-11 lg:h-14 ${isJumpOpen ? `w-0` : `${direction === 'rtl' ? 'mr-2.5' : 'ml-2.5'} w-12 lg:w-16`} transition-all duration-200 ease-out `}>
                                        <div
                                            className={` absolute top-0 h-full w-full pt-3.5 lg:pt-4 text-xl lg:text-2xl xl:text-3xl ${colors[theme]["text"]["on-deep"]} flex items-center justify-start ${isJumpOpen ? `hidden` : `w-20`}`}
                                            onClick={() => document.getElementById('pageselect').click()}>
                                        ...
                                        {<div dir={direction} className={`text-xs absolute top-0.5 lg:top-1 ${direction === 'rtl' ? `right-0.5` : ` left-0.5`} ${colors[theme]["text"]["on-deep-soft"]} brightness-80 ${isJumpOpen ? `hidden` : ``}`}>{translationApplication?.page}</div>}
                                        <select
                                            id="pageselect"
                                            name="pageselect"
                                            value={currentPage}
                                    ...
                                    <div className={` relative h-11 lg:h-14 ${isJumpOpen ? `w-0` : `${direction === 'rtl' ? 'mr-2.5' : 'ml-2.5'} w-12`} transition-all duration-200 ease-out `}>
                                        <div
                                            className={` absolute top-0 h-full w-full pt-2.5 lg:pt-3 text-2xl lg:text-3xl xl:text-4xl ${colors[theme]["text"]["on-deep"]} flex items-center justify-start ${isJumpOpen ? `hidden` : `w-20`}`}
                                        ...
                                        {<div dir={direction} className={`text-xs absolute top-0.5 lg:top-1 ${direction === 'rtl' ? `right-0.5` : ` left-0.5`} ${colors[theme]["text"]["on-deep-soft"]} brightness-80 ${isJumpOpen ? `hidden` : ``}`}>{translationApplication?.appendix}</div>}
                                        <select
                                            id="appselect"
                                            name="appselect"
                                            value={selectedApp}
                        ...
                        <div className={`w-1/2 h-full`}>
                            {multiSelect ?
                                (<button onClick={handleCopy}
                                    disabled={selectedVerseList.length === 0}
                                    className={`${colors[theme]["text"]["on-deep-soft"]} flex items-center w-full h-full justify-start`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-8 h-8 lg:w-11 lg:h-11 ${selectedVerseList.length > 0 ? `${colors[theme]["text"]["on-deep"]}` : ``}`}>
                                    ...
                                    {selectedVerseList.length > 0 && (
                                        <div className={`bg-transparent absolute translate-y-4 translate-x-5 text-xs lg:translate-y-5 lg:translate-x-6 lg:text-sm ${colors[theme]["accent"]["on-deep"]} flex items-center justify-center px-2 py-1 rounded-full`}>
                                ...
                                (
                                    <LongPressable
                                        ...
                                        <button
                                            ...
                                            className={`w-full h-full ${colors[theme]["text"]["on-deep"]} px-2 ${direction === 'rtl' ? 'mr-2' : 'ml-1'} flex items-center justify-center ${direction === 'rtl' ? (isJumpOpen || currentPage === 1 || isMagnifyOpen) ? "opacity-0" : "opacity-100" : (isJumpOpen || (selectedApp === 38 && currentPage === 397) || isMagnifyOpen) ? "opacity-0" : "opacity-100"} `}>
                                            <div className="relative flex items-center justify-center">
                ...
                <div className={`w-screen h-full fixed left-0 top-0 inset-0 z-[90] outline-none focus:outline-none`}>
                    <div
                        ...
                        {prevSettingsOpenningProgress !== 1 ? (
                            <div className={`flex items-center justify-center transition-all duration-300 ease-linear ${prevSettingsOpenningProgress < 0.57 ? " " : " rotate-180 "} ${prevSettingsOpenningProgress >= 0.57 ? colors[theme]["accent"]["on-deep"] : colors[theme]["text"]["on-deep-soft"]}`}>
                            ...
                            (<div
                                ...
                                <div dir={direction} className={`rounded px-1 py-1.5 border ${colors[theme]["border"]["strong"]}`}
                                    ...
                                    <div className={`flex flex-col text-lg md:text-xl`}>
                                        ...
                                        <label className={`flex items-center justify-between md:justify-end gap-4 pt-3.5 px-3 pb-2 cursor-pointer`}>
                                            <span className={`text-base break-words ${rememberHistory ? `` : ` brightness-50`} ${(keepVerseDetailsOpen && rememberHistory) ? colors[theme]["text"]["on-deep"] : colors[theme]["text"]["on-deep-soft"]}`}>{translationApplication?.keepDetailsOpen}</span>
                                            <div>
                                                <label className='flex cursor-pointer select-none items-center'>
                                                    <div className='relative'>
                                                        <input
                                        ...
                                        <div className={`border-b ${colors[theme]["border"]["soft"]} mx-1 mt-2`} ></div>
                                        <label className={`flex items-center justify-between md:justify-end gap-4 pt-3.5 px-3 pb-2 cursor-pointer`}>
                                            <span className={`text-base break-words ${rememberHistory ? `` : ` brightness-50`} ${(includeSearchScreen && rememberHistory) ? colors[theme]["text"]["on-deep"] : colors[theme]["text"]["on-deep-soft"]}`}>{translationApplication?.includeSearch}</span>
                                            <div>
                                                <label className='flex cursor-pointer select-none items-center'>
                                                    <div className='relative'>
                                                        <input
