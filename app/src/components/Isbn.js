...
const Isbn = ({ colors, theme, translationApplication }) => {
    ...
    return (
        <div className={`h-screen w-screen relative ${baseTextColor} text-lg md:text-xl lg:text-2xl select-text`}
            style={{ paddingBottom: 'calc((var(--app-safe-bottom) * 1.90) + 4rem)' }}>
                ...
                {loading ? (
                    ...
                    <>
                        <div className={`flex flex-1 w-full p-0.5 lg:p-2`}>
                            <div className={`flex flex-col border p-0.5 rounded-b-md ${colors[theme]["border"]["strong"]}`}>
