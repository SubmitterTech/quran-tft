...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // Apps built with the iOS 27 SDK must adopt the scene life cycle or UIKit stops them at launch.
    // The window and the web view are created by SceneDelegate, which also receives the URLs and
    // user activities that used to arrive at the two methods above.
